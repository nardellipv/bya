					...
					<div class="carousel-inner">
						<div class="carousel-item active">
							<div class="row d-flex align-items-center">
								...
								<div class="col">
									<img src="{{ asset('assets/web/images/slider/04.png') }}" class="img-fluid" alt="...">
								</div>
							</div>
						</div>
						<div class="carousel-item">
							<div class="row d-flex align-items-center">
								...
								<div class="col">
									<img src="{{ asset('assets/web/images/slider/05.png') }}" class="img-fluid" alt="...">
								</div>
							</div>
						</div>
						<div class="carousel-item">
							<div class="row d-flex align-items-center">
								...
								<div class="col">
									<img src="{{ asset('assets/web/images/slider/03.png') }}" class="img-fluid" alt="...">
								</div>
							</div>
						</div>
					</div>
